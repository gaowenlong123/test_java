 ...
 * generated in the com.gao.weather package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://weather.gao.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://weather.gao.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.gao.weather
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather.gao.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weather.gao.com/", name = "queryWeatherResponse")
